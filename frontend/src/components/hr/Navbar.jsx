  ...
  return (
    <nav className="border-scale-300 border-b backdrop-blur-md py-1.5 transition-opacity border-slate-400 dark:text-white text-semibold mx-24">
      <div className="flex  mx-4 justify-between">
        <div className="mt-4">
           <Link className={`px-4 ${isActiveRoute('/home') ? 'text-purple-500 font-semibold' : ''}`} to="/hr/home">Home</Link>
        </div>
        <div className="flex flex-row">
          ...
          <button className="p-3 mt-2 rounded-xl text-2xl " onClick={LogUserOut}>
            Logout
          </button>
        </div>
