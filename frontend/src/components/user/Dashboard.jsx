...
function Dashboard() {
    ...
    return (
        <div className='bg-white dark:bg-slate-950 h-screen '>
            <Navbar />
            <form className='container mx-auto mt-8 flex flex-col justify-center items-center text-white'>
                <h2 className='text-2xl font-bold mb-4'>Upload Your Resume</h2>

                <div className="flex items-center justify-center w-96 my-4">
                    <label htmlFor="resumeFile" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer ">
